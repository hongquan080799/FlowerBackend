...
public class CTDHController {
	...
	@GetMapping("/ctdh/{makh}/{masp}")
	public ResponseEntity<Boolean> getCTDH(@PathVariable("makh") String makh,@PathVariable("masp") String masp) {
		List<Donhang> listDH = dhRepo.getDonhangByMakh(makh);
